...
extern crate timely;
#[cfg(feature = "json-source")] extern crate json;
                                ...
                                for (k, v) in obj.entries() {
                                    match v {
                                        json::JsonValue::Short(v) => {
                                            session.give((vec![Value::Eid(object_index as u64), Value::String(k.to_string()), Value::String(v.to_string())], RootTimestamp::new(0), 1));
                                        },
